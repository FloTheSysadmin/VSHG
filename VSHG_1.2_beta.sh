...
echo "Do you want to us a custom keyfile ? (Y/N)"
echo ""
...
sudo echo $final | sudo gpg --batch -q --passphrase-fd 0 -o "$filetoenc2.vshg" --s2k-mode 3 --s2k-count 65011712 --s2k-digest-algo sha512 --s2k-cipher-algo AES256 --symmetric --armor --cipher-algo AES256 -c "$filetoenc2" 
