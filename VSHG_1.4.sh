...
sudo echo $finalcascade2 | sudo gpg --batch -q --passphrase-fd 0 -o "$filetoenc2.tmp.vshg" --s2k-mode 3 --s2k-count 65011712 --s2k-digest-algo sha512 --s2k-cipher-algo AES256 --symmetric --armor --cipher-algo AES256 -c "$filetoenc2" 

sudo echo $finalcascade3 | sudo gpg --batch -q --passphrase-fd 0 -o "$filetoenc2.vshg" --s2k-mode 3 --s2k-count 65011712 --s2k-digest-algo sha512 --s2k-cipher-algo TWOFISH --symmetric --armor --cipher-algo TWOFISH -c "$filetoenc2.tmp.vshg" 
